...
(function () {
    ...
    Framework7.prototype.device = (function () {
        ...
        // iOS 8+ changed UA
        if (device.ios && device.osVersion && ua.indexOf('Version/index.html') >= 0) {
            if (device.osVersion.split('.')[0] === '10') {
                device.osVersion = ua.toLowerCase().split('version/index-2.html')[1].split(' ')[0];
            }
        }
        ...
        function stringToBlocks(string) {
            ...
            for (i = 0; i < _blocks.length; i++) {
                ...
                if (block.indexOf('{{') < 0) {
                    ...
                    if (block.indexOf('%7b/index.html') >= 0) {
                        continue;
                    }
                    ...
                    if (block.indexOf('{#') >= 0) {
                        ...
                        for (j = i + 1; j < _blocks.length; j++) {
                            ...
                            if (_blocks[j].indexOf('%7b%7b/index.html') >= 0) {
                                depth --;
                            }
